...
By default, the service expects the Laravel project at `../my-laravel-app` relative to the python directory.

To change this, modify `LARAVEL_PROJECT_PATH` in [models.py](models.py):

```python
LARAVEL_PROJECT_PATH = os.path.join(os.path.dirname(__file__), '../your-laravel-app')
```
